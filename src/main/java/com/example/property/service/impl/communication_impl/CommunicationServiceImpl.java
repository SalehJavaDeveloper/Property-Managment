...
public class CommunicationServiceImpl implements CommunicationService {
    ...
    @Override
    public int sentMessagesNumber() {
        List<Communication> communicationsByMessageStatus = communicationRepository.getCommunicationsByMessageStatus(MessageStatus.SUCCESSFUL);

        return communicationsByMessageStatus.size();
    }
}
