...
public class CommunicationPropertyServiceImpl implements CommunicationPropertyService {
    ...
    public void saveCommunicationProperty(CommunicationPropertyRequestDto communicationPropertyRequestDto) {
        ...
        List<Long> propertyIds = communicationPropertyRequestDto.getPropertyId();
        for (Long id: propertyIds){
            PropertyEntity referenceById = propertyRepository.getReferenceById(id);
            properties.add(referenceById);
        }
        communicationProperty.setPropertyEntities(properties);
        communicationProperty.setCommunication(communicationRepository.getReferenceById(communicationPropertyRequestDto.getCommunicationId()));
