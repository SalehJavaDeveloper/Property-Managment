...
public class  TenantController {
    ...
    @Operation(summary = "Number of active tenants")
    public ResponseEntity<SuccessDetails<Integer>> getActiveTenantsNumber() throws MethodArgumentNotValidException {
        return ResponseEntity.ok(new SuccessDetails<>(tenantService.activeTenantNumber(),HttpStatus.OK.value(),true));
    }
}
