...
public class CommunicationController {
    ...
    @Operation(summary = "Number of sent message")
    public ResponseEntity<SuccessDetails<Integer>> getSetMessage() throws MethodArgumentNotValidException {
        return ResponseEntity.ok(new SuccessDetails<>(communicationService.sentMessagesNumber(),HttpStatus.OK.value(),true));
    }
